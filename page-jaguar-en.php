...
<div id="jaguar_brand_top_screen" class="brand_top_screen">
	<div class="container">
		<h1>Jaguar</h1>
	</div>
</div>
	...
	<div class="container">
		<div class="row">
			<div class="left_part col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<p>
					Sportive dynamic and stunning luxury that are worth your attention. 
					From 2004, we propose to real connoisseurs of English legend to get to know spirit and embodiment of especial quality of Jaguar.
				</p>
				...
				<div class="brand_link_block">
					...
					<p>
						<a href="https://www.jaguar.ua" target="_blank">www.jaguar.ua</a>
					</p>
				</div>
			</div>
			<div class="right_part col-lg-8 col-md-8 col-sm-12 col-xs-12">
				<img src="<?php bloginfo('stylesheet_directory'); ?>/img/brands/jaguar/top_content.jpg" alt="" />
			</div>
		</div>
	</div>
</div>
...
<div id="brand_page_dealer_map_screen">
	<div id="brand_page_dealer_map_screen_inner" class="container">
		...
		<h2 class="brand_h2">
			We invite you to make sure of unsurpassed brand<br/> in quality in one of five dealer centers
		</h2>
		...
		<div id="become_a_dealer_block_info">
			<p>To become a dealer of Jaguar</p>
			<p>
...
<!-- BEGIN .subscribe_screen -->
	<div id="jaguar_page_subscribe_screen" class="subscribe_screen">
		<div class="subscribe_screen_inner container">
			
			<h2>Subscribe to Jaguar news</h2>
			
			<form class="subscribe_form jaguar_page_subscribe_form form" method="post" autocomplete="on">
				<input class="field_checkout" name="checkout" type="text" placeholder="First name" />
				<input class="type" type="hidden" name="type" value="jaguar_page"/>
...
<script> 
	...
	function init(){
		...
		var mapIcon = "/wp-content/themes/winner-ua/img/brands/jaguar/map_point_jaguar.png";
		var locations = [
