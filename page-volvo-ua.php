	...
	<div class="container">
		<div class="row">
			<div class="left_part col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<p>
					Volvo – це інновації, автентичність і вершина
					скандинавської майстерності. Майже 17 років 
					ми пишаємося представляти шведський бренд тим, 
					хто прагне до покращення свого життя! 
					Обираючи Volvo, ви обираєте турботу
					та унікальність для себе та своєї родини
				</p>
...
<div id="brand_page_dealer_map_screen">
	<div id="brand_page_dealer_map_screen_inner" class="container">
		...
		<h2 class="brand_h2">
			На сьогоднішній день, ви маєте нагоду відкрити Volvo для себе<br/>
			в 9 офіційних дилерських центрах
		</h2>
...
<!-- BEGIN .subscribe_screen -->
	<div id="volvo_page_subscribe_screen" class="subscribe_screen">
		<div class="subscribe_screen_inner container">
			...
			<h2>Підписатися на новини Volvo</h2>
...
<script> 
	...
	function init(){
		...
		var locations = [
			...
			["ТОВ «Авто Граф М»", "м. Харків, Котлова, 29", "+380577171702", "http://agm.volvocarsdealer.com", "", 49.996156, 36.211749, mapIcon]
		];
