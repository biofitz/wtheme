...
var V = new function(){
	...
	this.dataEmptyPhone = "введіть контактні телефони",
	this.dataEmptyEmail = "введіть e-mail",
	this.dataEmptyElse = "заповніть це поле",
	this.dataEmptyCharityDate = "виберіть дату",

	this.dataWrongPhone = "введіть коректні телефони",
	this.dataWrongEmail = "введіть коректний e-mail",
	this.dataWrongElse = "заповніть це поле",
	this.dataWrongCharityDate = "виберіть дату",
        ...
        success: function(response){
			...
			if(response == "Sent"){
				if($(form).hasClass("simple_form")){
					...
					$("#form_popup").find("p:eq(1)").text("Ваша заявка відправлена");
