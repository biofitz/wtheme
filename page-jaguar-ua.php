	...
	<div class="container">
		<div class="row">
			<div class="left_part col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<p>
					Спортивна динаміка та вражаюча розкіш,
					що заслуговує на Вашу увагу. З 2014
					року ми пропонуємо справжнім поціновувачам англійської легенди познайомитися із духом 
					та втіленням виняткової якості Jaguar
				</p>
...
<div id="brand_page_dealer_map_screen">
	<div id="brand_page_dealer_map_screen_inner" class="container">
		...
		<h2 class="brand_h2">
			Запрошуємо переконатися в неперевершеній якості бренду<br/>
			до одного із 5 дилерських центрів 
		</h2>
...
<div id="jaguar_page_subscribe_screen" class="subscribe_screen">
	<div class="subscribe_screen_inner container">
		...
		<h2>Підписатися на новини Jaguar</h2>
